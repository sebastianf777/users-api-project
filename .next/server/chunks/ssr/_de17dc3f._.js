...
"[project]/.next-internal/server/app/(overview)/users/page/actions.js [app-rsc] (server actions loader, ecmascript)": (function(__turbopack_context__) {
...
"[project]/src/app/(overview)/users/page.tsx [app-rsc] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function UsersPage({ searchParams }) {
    ...
    const data = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$user$2e$service$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getUsers"])();
    const allColumns = [
        {
            key: 'id',
            header: 'ID'
...
"[project]/src/app/(overview)/users/page.tsx [app-rsc] (ecmascript, Next.js server component)": ((__turbopack_context__) => {

var { g: global, d: __dirname } = __turbopack_context__;
{
__turbopack_context__.n(__turbopack_context__.i("[project]/src/app/(overview)/users/page.tsx [app-rsc] (ecmascript)"));
}}),

};

//# sourceMappingURL=_de17dc3f._.js.map